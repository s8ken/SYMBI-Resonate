-- SYMBI Resonate Experiments Core Tables (Simplified)
-- This migration creates the experiment system database schema without user dependencies
...
-- Row Level Security (RLS) policies - simplified without user dependencies
...
CREATE POLICY "Public can view experiments" ON experiments
    FOR SELECT USING (true);

CREATE POLICY "Authenticated can create experiments" ON experiments
    FOR INSERT WITH CHECK (true);

CREATE POLICY "Authenticated can update experiments" ON experiments
    FOR UPDATE USING (true);

CREATE POLICY "Authenticated can delete experiments" ON experiments
    FOR DELETE USING (true);

-- Similar policies for other tables
CREATE POLICY "Public can view experiment runs" ON experiment_runs
    FOR SELECT USING (true);

CREATE POLICY "Authenticated can create experiment runs" ON experiment_runs
    FOR INSERT WITH CHECK (true);

CREATE POLICY "Authenticated can update experiment runs" ON experiment_runs
    FOR UPDATE USING (true);
